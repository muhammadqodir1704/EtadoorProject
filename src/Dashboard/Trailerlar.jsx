        ...
        <table className="w-full mt-0">
          <thead className="w-full sticky top-1 bg-[#474668] z-10">
            <tr>
              ...
              <th className="px-4 py-2">Yili</th>
              <th className="px-4 py-2">Janri</th>
              <th className="px-4 py-2">Reyting</th>
          ...
          <tbody>
            {data.map((item, index) => (
              ...
              >
                ...
                <td className="px-4 py-2 text-center">{item.data || "N/A"}</td>
                <td className="px-4 py-2 text-center max-w-[100px]">
                  {item.genre || "N/A"}
                </td>
                <td className="px-4 py-2 text-center">
                  {item.status || "N/A"}
