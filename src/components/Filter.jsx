...
const Filter = () => {
  return (
    <div className="max-w-6xl mx-auto p-6 bg-gray-50 min-h-screen rounded-lg">
      <h2 style={{fontSize: 34 , fontWeight: 700}} className=" text-center mb-8">Подберите свою дверь</h2>
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-8">
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">
            Где будет использоваться
          </label>
          <select style={{width:450 ,height: 45}} className="w-full p-2 border border-gray-300 rounded">
      ...
      <div className="flex items-center mb-8">
        ...
        <div className="mb-8">
          ...
          <div className="flex gap-4 items-center mr-6">
            <button style={{ width: 80, height: 80 }} className=" bg-red-400 rounded-full border-2 border-gray-300"></button>
            <button style={{ width: 80, height: 80 }} className=" bg-red-400 rounded-full border-2 border-gray-300"></button>
            <button style={{ width: 80, height: 80 }} className=" bg-red-400 rounded-full border-2 border-gray-300"></button>
            <button style={{ width: 80, height: 80 }} className=" bg-red-400 rounded-full border-2 border-gray-300"></button>
            <button style={{ width: 80, height: 80 }} className=" bg-red-400 rounded-full border-2 border-gray-300"></button>
