        ...
        <NavLink to={`/detailProducts/${product.id}`}>
            <div className="w-[330px] h-[483px] bg-white  hover:shadow-2xl transition-all duration-300 overflow-hidden flex flex-col">
                ...
                <div className="p-6 flex flex-col flex-grow justify-between">
                    <div>
                        <h2 style={{ fontSize: 20, fontWeight: 400, }} className=" mb-2 line-clamp-2 font-circe">
                            {product.name}
                        </h2>
    ...
    return (
        <div className=" min-h-screen">
            <div className="container mx-auto px-4 py-12">
                <h1 style={{ fontSize: 34, fontWeight: 700 }} className="font-noto-sans-georgian  font-bold text-gray-900 mb-12">
                Похожие товары:
                                </h1>
                {loading ? (
