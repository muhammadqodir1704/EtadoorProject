        ...
        <div style={{ backgroundColor: '#F9F9F9', width: '100%', height: '100vh' }}>
            <div className='container mx-auto mt-10'>
                ...
                <div className='flex justify-center items-center mt-10 relative'>
                    ...
                    <div style={{ marginRight: 360 }} className=' flex  mb-64 absolute  z-10'>
                        <img src={Img6} alt="" className='absolute ' />
                        <img src={Img5} alt="" className='mt-5' />
                    </div>
                    <div style={{ marginRight: 360 }} className=' flex mb-16  absolute  z-10'>
                        <img src={Img8} alt="" className='absolute ' />
                        <img src={Img7} alt="" className='mt-5' />
                    </div>
                    <div style={{ marginRight: 360 }} className=' flex  mt-24 absolute z-10'>
                        <img src={Img10} alt="" className='absolute mt-5 ' />
                        <img style={{ width: 137.5, height: 36 }} src={Img11} alt="" className='mt-5' />
                    </div>
                    <div style={{ marginRight: 360 }} className=' flex mt-72 absolute z-10'>
                        <img src={Img12} alt="" className='absolute mt-5 ' />
                        <img style={{ width: 137.5, height: 36 }} src={Img11} alt="" className='mt-5' />
                    </div>
                </div>
                {/* part two */}
                <div style={{ marginLeft: 380 }} className='flex justify-center items-center relative'>
                ...
                <div style={{ marginTop: -400, marginLeft: 300, }} className='flex flex-col'>
                    <p style={{ fontSize: 20 }} className='-mt-10 z-10 -ml-5'>Высокое сопротивление <br /> теплопередаче</p>
                    <Box sx={{ width: 300,  }}>
                        <Grid container sx={{ justifyContent: 'center' }}>
                            <Grid item>
                                <Tooltip title="Композитные материалы, используемые при производстве дверей «EtaDoor» имеют сопротивление теплопередаче до 5 раз больше, чем древесные материалы из которых изготавливаются обычные двери" placement="top-start">
                                    <Button><img src={Toltip} alt="" /></Button>
                                </Tooltip>
                            </Grid>
                        </Grid>
                    </Box>
                    <p style={{ fontSize: 20 }} className='mt-10 -ml-28 z-10'>Низкая эмиссия вредных веществ</p>
                    <p style={{ fontSize: 20 }} className='mt-20 ml-16 z-10'>Долговечность</p>
                    <p style={{ fontSize: 20 }} className='mt-16 z-10 ml-10'>Легкость монтажа</p>
                </div>
            </div>
        </div>
    )
